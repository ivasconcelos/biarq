...
angular.module('biarq.construcao', ['ngRoute'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/construcao', {
            templateUrl: 'construcao/construcao.html',
            controller: 'construcaoCtrl'
        })
            .when('/construcao/:titulo/:id', {
                templateUrl: 'construcao/ver.html',
                controller: 'verConstrucaoCtrl'
            });
    }])
    ...
    .controller('verConstrucaoCtrl', ['$scope', '$routeParams', 'Construcao','$timeout', function ($scope, $routeParams, Construcao,$timeout) {
